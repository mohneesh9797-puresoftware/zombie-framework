...
public:
    Ms3dModelLayer(zfw::IBroadcastHandler& bh, zfw::IEngine& engine, zfw::IEntityWorld2& world,
...
private:
    EntityViewWithCustomData<Ms3dModel*, zfw::Model3D, zfw::Position> renderables;
